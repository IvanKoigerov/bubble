...
const BubbleWrapper = styled.button<{ isOpen?: boolean }>`
  ...
  align-items: center;
  overflow: hidden;
  width: ${(props) => props.theme.sizes.bubble};
  height: ${(props) => props.theme.sizes.bubble};
  border: none;
  border-radius: 100%;
  background: ${(props) => props.theme.colors.primary};
  box-shadow: ${(props) => props.theme.shadows.bubbleShadow};
  ...
  @media screen and (max-width: ${(props) => props.theme.breakpoints.mobile}) {
    ...
    width: ${(props) => props.isOpen && props.theme.sizes.bubbleOpenMobile};
    height: ${(props) => props.isOpen && props.theme.sizes.bubbleOpenMobile};
    background: ${(props) => props.isOpen && props.theme.colors.mobileCross};
  }
...
const BubbleImg = styled.div<{ isOpen?: boolean }>`
  position: relative;
  width: ${(props) => props.theme.sizes.bubbleImg};
  height: ${(props) => props.theme.sizes.bubbleImg};
